    ...
    return (
        <>
            <div className={"d-flex h-100 justify-content-center "}>
                <div style={{ backgroundColor: "white",width: "43%", maxWidth: 1000 , boxShadow: '1px 2px 10px #FFFFFF',padding: '2em'}}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", marginLeft: 10 }}>
                        <h2 style={{color: "black", fontFamily: "Barlow-Bold", marginBottom: 30 }}>Register</h2>
                    </div>
                    <div style={{ marginBottom: 20, display: "flex", flexWrap: "wrap" }}>
                        <FormControl variant="outlined" style={{ backgroundColor: "white",paddingLeft: 10, width: 250, marginBottom: 20, marginRight: 20 }}>
                            <InputLabel style={{color: "black" }}htmlFor="standard-adornment-email">First Name</InputLabel>
                            <Input label="Email ID"
                                id="standard-adornment-email"
                                onChange={handleChange('firstName')} />
                        </FormControl>
                        <FormControl variant="outlined" style={{ backgroundColor: "white", paddingLeft: 10, width: 250, marginBottom: 20, marginRight: 20 }}>
                            <InputLabel style={{color: "black" }}htmlFor="standard-adornment-email">Last Name</InputLabel>
                            <Input label="Email ID"
                                id="standard-adornment-email"
                                onChange={handleChange('lastName')} />
                        </FormControl>
                        <FormControl variant="outlined" style={{color: "black", backgroundColor: "white",paddingLeft: 10, width: 250, marginBottom: 20, marginRight: 20 }}>
                            <TextField label="Email ID" style={{color: "black" }}
                                id="standard-adornment-email"
                        ...
                        <FormControl variant="outlined" style={{color: "black",backgroundColor: "white", paddingLeft: 10, width: 250, marginBottom: 20, marginRight: 20 }}>
                            <TextField label="Login ID" style={{color: "black"}}
                                id="standard-adornment-email"
                        ...
                        <FormControl variant="outlined" style={{ paddingLeft: 10, width: 250, marginRight: 20 ,color: "black"}}>
                        ...
                        <FormControl style={{color: "black" }}variant="outlined" style={{ paddingLeft: 10, width: 250, marginBottom: 20, marginRight: 20,color: "white" }}>
                    ...
                    <div>
                        {
                            (values.emailId != "" && values.password != "" && values.confirmPassword != "" && values.contactNumber != "" && values.firstName != "" && values.loginId != "" && values.lastName != "") ?
                                <button style={{ borderWidth: 0, backgroundColor: "blue", color: "white", width: "70%", padding: 10, borderRadius: 20, marginBottom: 20 }} onClick={onRegisterClick}>Submit</button>
                                : <button style={{ borderWidth: 0, backgroundColor: "blue", color: "white", width: "70%", padding: 10, borderRadius: 20, marginBottom: 20 }}>SUBMIT</button>
                        }
                    </div>
