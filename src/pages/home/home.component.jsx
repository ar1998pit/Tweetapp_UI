...
export default function Home(props) {
    ...
    const generateTweets = () => {
        return allTweets.map((tweet, index) => {
            ...
            return (
                <div className="shadow" style={{backgroundColor: 'rgba(52, 52, 88, 0.6)', border: '1px solid white', width: "60%", marginLeft: "auto", marginRight: "auto", alignItems: "flex-start", display: "flex", flexDirection: "column", borderRadius: 10, marginBottom: 10 }}>
            ...
            <div className={"h-100"}>
                <div className="shadow" style={{ width: "60%", marginLeft: "auto", marginRight: "auto", alignItems: "flex-start", display: "inline-flex", flexDirection: "column", borderRadius: 10 }}>
                    <div style={{ alignItems: "flex-start", display: "inline-flex", width: "100%", padding: 20, borderRadius: 10, borderWidth: 1 }}>
                        ...
                        <textarea placeholder={"What's up ?"} multiple={4} style={{ width: "80%", height: 50, borderWidth: 0, resize: "none", padding: 10 }} maxLength={144} value={tweetMessage} onChange={(e) => setTweetMessage(e.target.value)} />
                        <button style={{ borderWidth: 0, backgroundColor: "rgba(52, 52, 88, 1.8)", color: "white", width: 100, padding: 10, borderRadius: 20, marginBottom: 20, marginRight: 40 }} onClick={onTweetClick}>Tweet</button>
